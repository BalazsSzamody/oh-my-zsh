...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/BalazsSzamody/oh-my-zsh/MaxiTuti/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/BalazsSzamody/oh-my-zsh/MaxiTuti/tools/install.sh -O -)"
```
